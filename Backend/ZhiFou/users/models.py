...
class UserManager (BaseUserManager):
    def create_user(self, user_account,user_name, password, user_phone='', email='', user_gender=0, user_url='/static/profile/default.png', user_credit=0,
                    status=1):
        user = self.model (
...
class User (AbstractBaseUser):
    ...
    user_url = models.CharField (verbose_name="头像", max_length=256)
