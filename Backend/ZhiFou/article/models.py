...
class Article(models.Model):
    ...
    point_count = models.PositiveIntegerField(verbose_name='点赞数', default=0)
...
class Board(models.Model):
    board_id = models.BigAutoField(verbose_name='留言编号', max_length=20, primary_key=True)
    content = models.CharField(verbose_name='内容', max_length=255)
    create_time = models.DateTimeField(verbose_name='留言的创建时间', auto_now=True)
    flag = models.SmallIntegerField(verbose_name='0为删除，1为发表', default=0)  # 标志位
    user_id = models.ForeignKey(User, models.DO_NOTHING, db_column='user_id', db_index=True)
...
class Record(models.Model):
    ...
    create_time = models.DateTimeField(verbose_name='点赞时间', auto_now=True, db_index=True)
...
class Collection(models.Model):
    ...
    flag = models.SmallIntegerField(verbose_name='0为删除，1为有效', default=0)
...
class Photo(models.Model):
    ...
    flag = models.SmallIntegerField(verbose_name='0为图片，1为视频，3为视频截图', default=0)
    article_id = models.BigIntegerField(verbose_name='文章编号', db_index=True)
